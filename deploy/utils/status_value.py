...
class StatusCode(Enum):
    ...
    CODE_205_USER_OLD_PASSWORD_ERROR = 205
    ...
    CODE_251_TOKEN_VERIFY_FAILURE = 251
    CODE_252_TOKEN_RTX_MISMATCH = 252
    CODE_253_TOKEN_EXPIRE = 253
    CODE_254_TOKEN_GENERATE_FAILURE = 254
    ...
    CODE_406_REQUEST_PARAMETER_RTX_TOKEN_MISMATCH = 406
    # ** request file **
